...
- To file an issue or a feature request, use the [GitHub Issue Tracker](https://github.com/ridsuteri/chatte-R/issues) and describe briefly what you are expecting.
...
1. Run `npm start dev` locally before pushing any commits or creating a Pull Request.
    - If `npm start dev` is failing locally, your Pull Request will also fail and won't be able to merge.
